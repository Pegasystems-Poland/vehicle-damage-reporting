...
internal class ModelScaleProvider : ModelScaleProviderProtocol {
    private let referenceModelScale: Float = 32.05522
    private let model: SCNNode
    
    init(_ model: SCNNode) {
        self.model = model
    }
    
    private func getModelScale() -> Float {
